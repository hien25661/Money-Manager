...
public class SoNoActivity extends Activity {
	...
	private AlertDialog makeDialog_Update() {
		...
		.setTitle("Warning")
		.setView(input)
		.setPositiveButton(this.getString(R.string.luu),
				new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog,
					int whichButton) {
				...
				new Access_VayNo(getApplicationContext()).UpdateTenNguoiVayNo(values.getList().get(mSelectedRow),tenNew);
				truyxuatDatabase();
		...
		.setNegativeButton(this.getString(R.string.huybo),
				new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog,
					int whichButton) {
...
/*class CallDialog extends Dialog implements OnClickListener {
	...
	private Button btnSua, btnXoa, btnHuy;
 ...
 * Intent luu lai Gridview gui qua
	...
	public CallDialog(Activity context,Intent intent,String tenNguoiGiaoDich) {
		...
		this.tenNguoiGiaoDich = tenNguoiGiaoDich;
		this.intent = intent;
  ...
  *//** Design the dialog in main.xml file *//*
   ...
   *//** When OK Button is clicked, dismiss the dialog *//*
		...
		case R.id.btnHuyBo_thaotac: {
			Intent intent = new Intent(context,SoNoChiTietActivity.class);
			intent.putExtra(Variable.NameUser_GiaoDichVayNo, tenNguoiGiaoDich);
			context.startActivityForResult(intent, Variable.requestcode_MoRong);
